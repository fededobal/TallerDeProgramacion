  ...
  begin
    if (a = nil) then
        ...
        if (a^.dato.codigo <= codigo1) then
            ...
            ObtenerMontoTotalEntreDosCodigos := montoActual + ObtenerMontoTotalEntreDosCodigos(a^.HI, codigo1, codigo2) + ObtenerMontoTotalEntreDosCodigos(a^.HD, codigo1, codigo2);
    end;
  end;

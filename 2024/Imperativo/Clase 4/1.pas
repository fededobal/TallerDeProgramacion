{a. Almacenar los productos vendidos en una estructura eficiente para la búsqueda por código de producto. 
	...
	*  De cada venta se cargan código de venta, código del producto vendido, cantidad de unidades vendidas y precio 
...
e. Retornar el monto total entre todos los códigos de productos comprendidos entre dos valores recibidos (sin incluir) 
* como parámetros.
...
{ Contenga un módulo que reciba la estructura generada en el punto a y dos códigos de producto y retorne el monto 
* total entre todos los códigos de productos 
comprendidos entre los dos valores recibidos (sin incluir). }
  ...
  begin
    if a = nil then
		...
		else if(a^.dato.codigo >= codigo2) then 
